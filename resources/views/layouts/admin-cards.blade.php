 ...
 <!--Will fix this mess and make a single card -->
 <!-- cards -->
 <div class="w-full px-6 py-6 mx-auto">
  ...
  <div class="flex flex-wrap mt-6 -mx-3">
                  ...
                  <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                    <div class="flex items-center px-2 py-1">
                      <div class="ml-6">
                        ...
                        <a href="/admin/{{ $ticket->ticket_id }}" class="mb-0 text-sm leading-normal dark:text-white">{{  $ticket->ticket_id}}</a><!--Link to user profile and tickets -->
                      </div>
                    </div>
                  </td>
    ...
    <div class="w-full max-w-full px-3 mt-0 lg:w-5/12 lg:flex-none">
      <div class="border-black/12.5 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl relative flex min-w-0 flex-col break-words roundF-2xl border-0 border-solid bg-white bg-clip-border">
